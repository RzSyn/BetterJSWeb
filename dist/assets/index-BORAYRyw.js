(function(){const p=document.createElement("link").relList;if(p&&p.supports&&p.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))u(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const f of c.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&u(f)}).observe(document,{childList:!0,subtree:!0});function y(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function u(l){if(l.ep)return;l.ep=!0;const c=y(l);fetch(l.href,c)}})();const m={gospelValues:{values:[{key:"J",term:"JUSTICE",desc:"ความยุติธรรม"},{key:"O",term:"OBEDIENCE",desc:"ความเชื่อฟัง"},{key:"S",term:"SILENCE",desc:"ความเงียบ สงบ"},{key:"E",term:"EXPERIENCE",desc:"ความฉลาดในการใช้ประสบการณ์ที่มี"},{key:"P",term:"PRUDENCE",desc:"ความสุขุม รอบคอบ มัธยัสถ์"},{key:"H",term:"HUMILITY",desc:"ความสุภาพ"}]},images:{history:"./images/history_meeting.jpg",news:["./images/news1_books.jpg","./images/news2_uniform.jpg","./images/boys_songkran2.jpg"],gallery:[{category:"ครบรอบ 60 ปี (2569)",url:"./images/hero_60years.jpg",desc:"งานฉลองครบรอบ 60 ปี โรงเรียนยอแซฟอุปถัมภ์ — คืนสู่เหย้าชาวเหลือง-เขียว",postDate:"21 มีนาคม 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran1.jpg",desc:"กิจกรรมสงกรานต์ วัฒนธรรมไทย / รดน้ำดำหัว / แต่งชุดไทย แผนกชาย",postDate:"10 เมษายน 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran2.jpg",desc:"กิจกรรมสงกรานต์ มินิคอนเสิร์ตแห่งวงดนตรี แผนกชาย ยอแซฟอุปถัมภ์",postDate:"10 เมษายน 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran3.jpg",desc:"สงกรานต์แผนกชาย — บรรยากาศครึกครื้นและเต็มไปด้วยรอยยิ้ม",postDate:"10 เมษายน 2569"},{category:"ประชุมคณะครู",url:"./images/history_meeting.jpg",desc:"ประชุมคณะครูและเจ้าหน้าที่โรงเรียนยอแซฟอุปถัมภ์ แผนกชาย (11 มี.ค. 2569)",postDate:"11 มีนาคม 2569"},{category:"ประชุมคณะครู",url:"./images/gallery_meeting2.jpg",desc:"บรรยากาศการประชุมและรับโล่รางวัล Empowering Innovation Teachers",postDate:"11 มีนาคม 2569"},{category:"ประกาศผลการเรียน",url:"./images/gallery_result.jpg",desc:"ประกาศผลการเรียน ป.1–ม.5 แผนกชาย พร้อมรับเอกสารรายงานผลรายบุคคล",postDate:"14 มีนาคม 2569"},{category:"ตารางเรียน SUMMER",url:"./images/gallery_summer.jpg",desc:"ตารางเรียนภาคฤดูร้อน (SUMMER) ประจำปีการศึกษา 2568",postDate:"9 มีนาคม 2569"}]}};document.addEventListener("DOMContentLoaded",()=>{const r=document.documentElement,p=document.querySelectorAll("#theme-toggle, #theme-toggle-mobile"),y=localStorage.getItem("theme"),u=window.matchMedia("(prefers-color-scheme: dark)").matches;y?r.setAttribute("data-theme",y):u?r.setAttribute("data-theme","dark"):r.setAttribute("data-theme","light"),p.forEach(e=>{e.addEventListener("click",()=>{const t=r.getAttribute("data-theme");let a="light";t==="light"&&(a="dark"),document.body.style.transition="background-color 0.4s ease, color 0.4s ease, border-color 0.4s ease, box-shadow 0.4s ease",r.setAttribute("data-theme",a),localStorage.setItem("theme",a);const s=document.getElementById("school-logo");s&&s.classList.contains("fallback-svg-active")&&C(s);const o=document.getElementById("footer-school-logo");o&&o.classList.contains("fallback-svg-active")&&C(o)})});const l=document.querySelectorAll(".dept-tab-btn"),c=document.querySelectorAll(".dept-pane");l.forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-target");l.forEach(s=>s.classList.remove("active")),c.forEach(s=>s.classList.remove("active")),e.classList.add("active");const a=document.getElementById(`pane-${t}`);a&&a.classList.add("active")})}),window.switchDept=e=>{const t=document.querySelector(`.dept-tab-btn[data-target="${e}"]`);if(t){t.click();const a=document.getElementById("departments");a&&a.scrollIntoView({behavior:"smooth"})}};const f=document.getElementById("navbar"),b=document.getElementById("back-to-top"),M=document.querySelectorAll(".nav-link"),H=document.querySelectorAll("section");window.addEventListener("scroll",()=>{const e=window.scrollY;f&&(e>50?f.classList.add("scrolled"):f.classList.remove("scrolled")),b&&(e>400?b.classList.add("visible"):b.classList.remove("visible"));let t="";H.forEach(a=>{const s=a.offsetTop-150,o=a.offsetHeight;e>=s&&e<s+o&&(t=a.getAttribute("id"))}),t&&M.forEach(a=>{a.classList.remove("active"),a.getAttribute("href")===`#${t}`&&a.classList.add("active")})}),b&&b.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const w=document.getElementById("mobile-menu-toggle"),v=document.getElementById("nav-menu");w&&v&&(w.addEventListener("click",()=>{v.classList.toggle("open");const e=w.querySelector("i");v.classList.contains("open")?e.className="fa-solid fa-xmark":e.className="fa-solid fa-bars"}),M.forEach(e=>{e.addEventListener("click",()=>{v.classList.remove("open"),w.querySelector("i").className="fa-solid fa-bars"})}));const x=document.getElementById("gospel-values-container");if(x){x.innerHTML="";const e={J:"fa-solid fa-scale-balanced",O:"fa-solid fa-hands-praying",S:"fa-solid fa-ear-listen",E:"fa-solid fa-brain",P:"fa-solid fa-shield-halved",H:"fa-solid fa-hands-bowing"},t={J:"ความเที่ยงธรรมและสุจริต มุ่งสร้างความเท่าเทียม ความรัก และความซื่อตรงในทุกมิติชีวิตของสังคม",O:"การเชื่อฟังและไว้วางใจ นอบน้อมต่อคำสอนของผู้ใหญ่ ครูอาจารย์ และเคารพกฎกติกาด้วยความจริงใจ",S:"ความเงียบและไตร่ตรอง ฝึกฝนจิตใจให้สงบนิ่งเพื่อรับฟังเสียงสัจธรรม ความคิดสร้างสรรค์ และสติปัญญา",E:"ความฉลาดในประสบการณ์ รู้จักประยุกต์เรียนรู้จากบทเรียนชีวิต ก้าวข้ามอุปสรรคและพัฒนาความรู้สู่การปฏิบัติจริง",P:"ความสุขุม รอบคอบ ประหยัดและมัธยัสถ์ คิดทบทวนก่อนทำสิ่งใดๆ มีเหตุผลและปกป้องตนเองจากความประมาท",H:"ความถ่อมตนและนอบน้อม ไม่เย่อหยิ่งจองหอง ยอมรับความเห็นของผู้อื่น และพร้อมรับการพัฒนาตนเองอย่างต่อเนื่อง"};m.gospelValues.values.forEach(a=>{const s=document.createElement("div");s.className="gospel-card card-glow",s.innerHTML=`
            ...
            `,x.appendChild(s)})}const g=document.getElementById("gallery-container");g&&(g.innerHTML="",m.images.gallery.forEach(e=>{const t=document.createElement("div");t.className="gallery-card card-glow",t.setAttribute("data-category",e.category),t.innerHTML=`
            ...
            `,g.appendChild(t)}));const L=document.querySelectorAll(".gallery-tab-btn");L.length>0&&g&&L.forEach(e=>{e.addEventListener("click",()=>{L.forEach(s=>s.classList.remove("active")),e.classList.add("active");const t=e.getAttribute("data-category");g.querySelectorAll(".gallery-card").forEach(s=>{const o=s.getAttribute("data-category");t==="ทั้งหมด"||o===t?(s.style.display="block",s.style.animation="none",s.offsetWidth,s.style.animation="fade-scale-in 0.4s ease forwards"):s.style.display="none"})})});function h(e){let t="";switch(e){case"hero":t=`
                ...
                </svg>`;break}return`data:image/svg+xml;utf8,${encodeURIComponent(t)}`}function C(e){const t=r.getAttribute("data-theme")==="dark",i=`
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
        ...
        </svg>`;e.src=`data:image/svg+xml;utf8,${encodeURIComponent(i)}`,e.classList.add("fallback-svg-active")}function S(e){const t=e.getAttribute("id"),a=e.getAttribute("src");if(console.log(`Failed to load image: ${a}. Applying premium vector fallback.`),t==="school-logo"||t==="footer-school-logo"){C(e);return}if(t==="hero-banner-image"){e.src=h("hero"),e.classList.add("fallback-svg-active");return}if(t==="history-main-image"){e.src=h("history"),e.classList.add("fallback-svg-active");return}if(t==="img-boys"){e.src=h("boys"),e.classList.add("fallback-svg-active");return}if(t==="img-girls"){e.src=h("girls"),e.classList.add("fallback-svg-active");return}if(t==="img-ep"){e.src=h("ep"),e.classList.add("fallback-svg-active");return}if(t==="img-kindergarten"){e.src=h("kindergarten"),e.classList.add("fallback-svg-active");return}if(t==="news-img-1"){e.src=`data:image/svg+xml;utf8,${encodeURIComponent(`
            ...
            `)}`,e.classList.add("fallback-svg-active");return}const o=`
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'>
            ...
            <text x='200' y='270' font-family='Sarabun, sans-serif' font-size='10' fill='#ffffff' text-anchor='middle' opacity='0.5'>JOSEPH UPATHAM SCHOOL GALLERY</text>
        </svg>`;e.src=`data:image/svg+xml;utf8,${encodeURIComponent(o)}`,e.classList.add("fallback-svg-active")}if(window.handleImageError=S,window.addEventListener("error",e=>{e.target.tagName==="IMG"&&S(e.target)},!0),document.querySelectorAll("img").forEach(e=>{e.naturalWidth===0&&e.src&&S(e)}),document.querySelectorAll(".interact-news").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const a=e.closest(".news-card"),s=a.querySelector(".news-card-title").textContent,o=a.querySelector(".news-img").src;Swal.fire({title:s,text:"กำลังปรับปรุงระบบให้แสดงเนื้อหาข่าวสารฉบับเต็ม กรุณาติดตามได้ในเร็วๆ นี้",imageUrl:o,imageWidth:400,imageAlt:"รูปภาพข่าว",confirmButtonText:"รับทราบ",confirmButtonColor:"#005a2b",background:r.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:r.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026"})})}),document.querySelectorAll(".interact-portal").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const a=e.getAttribute("data-portal-name"),s=e.getAttribute("data-portal-url");Swal.fire({title:"ยืนยันการเข้าสู่ระบบ",text:`คุณกำลังจะไปยัง "${a}" ดำเนินการต่อหรือไม่?`,icon:"question",showCancelButton:!0,confirmButtonColor:"#005a2b",cancelButtonColor:"#888",confirmButtonText:"เข้าสู่ระบบ",cancelButtonText:"ยกเลิก",background:r.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:r.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026"}).then(o=>{o.isConfirmed&&window.open(s,"_blank","noopener,noreferrer")})})}),g){g.addEventListener("click",t=>{const a=t.target.closest(".gallery-card");if(a){const s=a.querySelector("img"),o=a.querySelector(".gallery-lbl").textContent,d=a.querySelector(".gallery-caption").textContent;Swal.fire({title:o,text:d,imageUrl:s.src,imageAlt:o,confirmButtonText:"ปิด",confirmButtonColor:"#005a2b",width:"auto",imageWidth:"100%",background:r.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:r.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026",backdrop:"rgba(0, 0, 0, 0.85)"})}});const e=document.createElement("style");e.textContent=".gallery-card { cursor: pointer; } .gallery-card:hover .gallery-img { transform: scale(1.1); }",document.head.appendChild(e)}function E(e){try{if(e._embedded&&e._embedded["wp:featuredmedia"]&&e._embedded["wp:featuredmedia"][0])return e._embedded["wp:featuredmedia"][0].source_url||e._embedded["wp:featuredmedia"][0].media_details.sizes.medium.source_url}catch{}return"http://www.joseph.ac.th/wp-content/uploads/2026/04/05.jpg"}function k(e){try{if(e._embedded&&e._embedded.author&&e._embedded.author[0])return e._embedded.author[0].name}catch{}return"admin1"}function A(e){try{if(e._embedded&&e._embedded["wp:term"]){for(let t of e._embedded["wp:term"])for(let a of t)if(a.taxonomy==="category")return a.name}}catch{}return"ประกาศ"}function P(e){try{const t=new Date(e.date),a=["มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม"],s=t.getDate(),o=a[t.getMonth()],d=t.getFullYear()+543;return`${s} ${o} ${d}`}catch{}return"8 เมษายน 2569"}window.renderAllPosts=function(e){window.wpPostsSyncInitialized=!0,console.log("Rendering posts dynamically from WordPress API...");const t=document.getElementById("slider");if(t){try{jQuery(t).hasClass("slick-initialized")&&jQuery(t).slick("unslick")}catch(i){console.log("Slick destroy ignored:",i)}t.className="slick-slider";let o="";e.slice(0,6).forEach(i=>{o+=`
                <div class="projectitem">
                    <a class="sliderlink" href="${i.link}"> </a>
                    <div class="slider-container" style="background: url(${E(i)}) 50% 50% / cover no-repeat;">
                        <div class="post-header-outer is-absolute">
                            <div class="post-header">
                                <div class="post-cat-info">
                                    <a class="cat-info-el" href="${i.link}">${A(i)}</a>
                                </div>
                                <h3 class="post-title is-size-2">
                                    <a class="post-title-link" href="${i.link}" rel="bookmark">${i.title.rendered}</a>
                                </h3>
                                <div class="post-meta-info">
                                    <div class="post-meta-info-left">
                                        <span class="meta-info-el meta-info-author">
                                            <a class="vcard author" href="${i.link}">${k(i)}</a>
                                        </span>
                                        <span class="meta-info-el meta-info-date">
                                            <time class="date update">${P(i)}</time>
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                `}),t.innerHTML=o;try{jQuery(t).slick({slidesToShow:1,pauseOnHover:!1,autoplaySpeed:4e3,adaptiveHeight:!1,speed:400,prevArrow:'<div class="newspaperss-slider-nav newspaperss-slider-prev"><i class="fa fa-angle-left" aria-hidden="true"></i></div>',nextArrow:'<div class="newspaperss-slider-nav newspaperss-slider-next"><i class="fa fa-angle-right" aria-hidden="true"></i></div>',responsive:[{breakpoint:1023,settings:{adaptiveHeight:!1,slidesToShow:1,slidesToScroll:1}}]})}catch(i){console.error("Failed to re-initialize slick slider:",i)}}const a=document.querySelector(".slider-right .grid-x");if(a){let o="";e.slice(0,2).forEach(i=>{o+=`
                    ...
                    <article class="post-wrap">
                        <div class="post-image-warp">
                            ...
                            <span class="thumbnail-post">
                                <a href="${i.link}">
                                    <img alt="" class="object-fit-postimg wp-post-image" height="400" loading="lazy" src="${E(i)}" width="428"/>
                                </a>
                            </span>
                        </div>
                        <div class="post-header-outer is-absolute">
                ...
                `}),a.innerHTML=o}const s=document.querySelector("#site-content .grid-x");if(s){const o=s.querySelector(".block-title");let d=o?o.outerHTML:`
