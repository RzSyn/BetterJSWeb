(function(){const p=document.createElement("link").relList;if(p&&p.supports&&p.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))u(l);new MutationObserver(l=>{for(const c of l)if(c.type==="childList")for(const f of c.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&u(f)}).observe(document,{childList:!0,subtree:!0});function y(l){const c={};return l.integrity&&(c.integrity=l.integrity),l.referrerPolicy&&(c.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?c.credentials="include":l.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function u(l){if(l.ep)return;l.ep=!0;const c=y(l);fetch(l.href,c)}})();const h={gospelValues:{values:[{key:"J",term:"JUSTICE",desc:"ความยุติธรรม"},{key:"O",term:"OBEDIENCE",desc:"ความเชื่อฟัง"},{key:"S",term:"SILENCE",desc:"ความเงียบ สงบ"},{key:"E",term:"EXPERIENCE",desc:"ความฉลาดในการใช้ประสบการณ์ที่มี"},{key:"P",term:"PRUDENCE",desc:"ความสุขุม รอบคอบ มัธยัสถ์"},{key:"H",term:"HUMILITY",desc:"ความสุภาพ"}]},images:{history:"./images/history_meeting.jpg",news:["./images/news1_books.jpg","./images/news2_uniform.jpg","./images/boys_songkran2.jpg"],gallery:[{category:"ครบรอบ 60 ปี (2569)",url:"./images/hero_60years.jpg",desc:"งานฉลองครบรอบ 60 ปี โรงเรียนยอแซฟอุปถัมภ์ — คืนสู่เหย้าชาวเหลือง-เขียว",postDate:"21 มีนาคม 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran1.jpg",desc:"กิจกรรมสงกรานต์ วัฒนธรรมไทย / รดน้ำดำหัว / แต่งชุดไทย แผนกชาย",postDate:"10 เมษายน 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran2.jpg",desc:"กิจกรรมสงกรานต์ มินิคอนเสิร์ตแห่งวงดนตรี แผนกชาย ยอแซฟอุปถัมภ์",postDate:"10 เมษายน 2569"},{category:"กิจกรรมสงกรานต์ 2569 (แผนกชาย)",url:"./images/boys_songkran3.jpg",desc:"สงกรานต์แผนกชาย — บรรยากาศครึกครื้นและเต็มไปด้วยรอยยิ้ม",postDate:"10 เมษายน 2569"},{category:"ประชุมคณะครู",url:"./images/history_meeting.jpg",desc:"ประชุมคณะครูและเจ้าหน้าที่โรงเรียนยอแซฟอุปถัมภ์ แผนกชาย (11 มี.ค. 2569)",postDate:"11 มีนาคม 2569"},{category:"ประชุมคณะครู",url:"./images/gallery_meeting2.jpg",desc:"บรรยากาศการประชุมและรับโล่รางวัล Empowering Innovation Teachers",postDate:"11 มีนาคม 2569"},{category:"ประกาศผลการเรียน",url:"./images/gallery_result.jpg",desc:"ประกาศผลการเรียน ป.1–ม.5 แผนกชาย พร้อมรับเอกสารรายงานผลรายบุคคล",postDate:"14 มีนาคม 2569"},{category:"ตารางเรียน SUMMER",url:"./images/gallery_summer.jpg",desc:"ตารางเรียนภาคฤดูร้อน (SUMMER) ประจำปีการศึกษา 2568",postDate:"9 มีนาคม 2569"}]}};document.addEventListener("DOMContentLoaded",()=>{const i=document.documentElement,p=document.querySelectorAll("#theme-toggle, #theme-toggle-mobile"),y=localStorage.getItem("theme"),u=window.matchMedia("(prefers-color-scheme: dark)").matches;y?i.setAttribute("data-theme",y):u?i.setAttribute("data-theme","dark"):i.setAttribute("data-theme","light"),p.forEach(e=>{e.addEventListener("click",()=>{const t=i.getAttribute("data-theme");let a="light";t==="light"&&(a="dark"),document.body.style.transition="background-color 0.4s ease, color 0.4s ease, border-color 0.4s ease, box-shadow 0.4s ease",i.setAttribute("data-theme",a),localStorage.setItem("theme",a);const o=document.getElementById("school-logo");o&&o.classList.contains("fallback-svg-active")&&C(o);const s=document.getElementById("footer-school-logo");s&&s.classList.contains("fallback-svg-active")&&C(s)})});const l=document.querySelectorAll(".dept-tab-btn"),c=document.querySelectorAll(".dept-pane");l.forEach(e=>{e.addEventListener("click",()=>{const t=e.getAttribute("data-target");l.forEach(o=>o.classList.remove("active")),c.forEach(o=>o.classList.remove("active")),e.classList.add("active");const a=document.getElementById(`pane-${t}`);a&&a.classList.add("active")})}),window.switchDept=e=>{const t=document.querySelector(`.dept-tab-btn[data-target="${e}"]`);if(t){t.click();const a=document.getElementById("departments");a&&a.scrollIntoView({behavior:"smooth"})}};const f=document.getElementById("navbar"),b=document.getElementById("back-to-top"),I=document.querySelectorAll(".nav-link"),T=document.querySelectorAll("section");window.addEventListener("scroll",()=>{const e=window.scrollY;f&&(e>50?f.classList.add("scrolled"):f.classList.remove("scrolled")),b&&(e>400?b.classList.add("visible"):b.classList.remove("visible"));let t="";T.forEach(a=>{const o=a.offsetTop-150,s=a.offsetHeight;e>=o&&e<o+s&&(t=a.getAttribute("id"))}),t&&I.forEach(a=>{a.classList.remove("active"),a.getAttribute("href")===`#${t}`&&a.classList.add("active")})}),b&&b.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const w=document.getElementById("mobile-menu-toggle"),v=document.getElementById("nav-menu");w&&v&&(w.addEventListener("click",()=>{v.classList.toggle("open");const e=w.querySelector("i");v.classList.contains("open")?e.className="fa-solid fa-xmark":e.className="fa-solid fa-bars"}),I.forEach(e=>{e.addEventListener("click",()=>{v.classList.remove("open"),w.querySelector("i").className="fa-solid fa-bars"})}));const x=document.getElementById("gospel-values-container");if(x){x.innerHTML="";const e={J:"fa-solid fa-scale-balanced",O:"fa-solid fa-hands-praying",S:"fa-solid fa-ear-listen",E:"fa-solid fa-brain",P:"fa-solid fa-shield-halved",H:"fa-solid fa-hands-bowing"},t={J:"ความเที่ยงธรรมและสุจริต มุ่งสร้างความเท่าเทียม ความรัก และความซื่อตรงในทุกมิติชีวิตของสังคม",O:"การเชื่อฟังและไว้วางใจ นอบน้อมต่อคำสอนของผู้ใหญ่ ครูอาจารย์ และเคารพกฎกติกาด้วยความจริงใจ",S:"ความเงียบและไตร่ตรอง ฝึกฝนจิตใจให้สงบนิ่งเพื่อรับฟังเสียงสัจธรรม ความคิดสร้างสรรค์ และสติปัญญา",E:"ความฉลาดในประสบการณ์ รู้จักประยุกต์เรียนรู้จากบทเรียนชีวิต ก้าวข้ามอุปสรรคและพัฒนาความรู้สู่การปฏิบัติจริง",P:"ความสุขุม รอบคอบ ประหยัดและมัธยัสถ์ คิดทบทวนก่อนทำสิ่งใดๆ มีเหตุผลและปกป้องตนเองจากความประมาท",H:"ความถ่อมตนและนอบน้อม ไม่เย่อหยิ่งจองหอง ยอมรับความเห็นของผู้อื่น และพร้อมรับการพัฒนาตนเองอย่างต่อเนื่อง"};h.gospelValues.values.forEach(a=>{const o=document.createElement("div");o.className="gospel-card card-glow",o.innerHTML=`
            ...
            `,x.appendChild(o)})}const g=document.getElementById("gallery-container");g&&(g.innerHTML="",h.images.gallery.forEach(e=>{const t=document.createElement("div");t.className="gallery-card card-glow",t.setAttribute("data-category",e.category),t.innerHTML=`
            ...
            `,g.appendChild(t)}));const L=document.querySelectorAll(".gallery-tab-btn");L.length>0&&g&&L.forEach(e=>{e.addEventListener("click",()=>{L.forEach(o=>o.classList.remove("active")),e.classList.add("active");const t=e.getAttribute("data-category");g.querySelectorAll(".gallery-card").forEach(o=>{const s=o.getAttribute("data-category");t==="ทั้งหมด"||s===t?(o.style.display="block",o.style.animation="none",o.offsetWidth,o.style.animation="fade-scale-in 0.4s ease forwards"):o.style.display="none"})})});function m(e){let t="";switch(e){case"hero":t=`
                ...
                </svg>`;break}return`data:image/svg+xml;utf8,${encodeURIComponent(t)}`}function C(e){const t=i.getAttribute("data-theme")==="dark",r=`
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
            ...
            `)}`,e.classList.add("fallback-svg-active");return}const s=`
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 300'>
            ...
            <text x='200' y='270' font-family='Sarabun, sans-serif' font-size='10' fill='#ffffff' text-anchor='middle' opacity='0.5'>JOSEPH UPATHAM SCHOOL GALLERY</text>
        </svg>`;e.src=`data:image/svg+xml;utf8,${encodeURIComponent(s)}`,e.classList.add("fallback-svg-active")}if(window.handleImageError=S,window.addEventListener("error",e=>{e.target.tagName==="IMG"&&S(e.target)},!0),document.querySelectorAll("img").forEach(e=>{e.naturalWidth===0&&e.src&&S(e)}),document.querySelectorAll(".interact-news").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const a=e.closest(".news-card"),o=a.querySelector(".news-card-title").textContent,s=a.querySelector(".news-img").src;Swal.fire({title:o,text:"กำลังปรับปรุงระบบให้แสดงเนื้อหาข่าวสารฉบับเต็ม กรุณาติดตามได้ในเร็วๆ นี้",imageUrl:s,imageWidth:400,imageAlt:"รูปภาพข่าว",confirmButtonText:"รับทราบ",confirmButtonColor:"#005a2b",background:i.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:i.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026"})})}),document.querySelectorAll(".interact-portal").forEach(e=>{e.addEventListener("click",t=>{t.preventDefault();const a=e.getAttribute("data-portal-name"),o=e.getAttribute("data-portal-url");Swal.fire({title:"ยืนยันการเข้าสู่ระบบ",text:`คุณกำลังจะไปยัง "${a}" ดำเนินการต่อหรือไม่?`,icon:"question",showCancelButton:!0,confirmButtonColor:"#005a2b",cancelButtonColor:"#888",confirmButtonText:"เข้าสู่ระบบ",cancelButtonText:"ยกเลิก",background:i.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:i.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026"}).then(s=>{s.isConfirmed&&window.open(o,"_blank","noopener,noreferrer")})})}),g){g.addEventListener("click",t=>{const a=t.target.closest(".gallery-card");if(a){const o=a.querySelector("img"),s=a.querySelector(".gallery-lbl").textContent,d=a.querySelector(".gallery-caption").textContent;Swal.fire({title:s,text:d,imageUrl:o.src,imageAlt:s,confirmButtonText:"ปิด",confirmButtonColor:"#005a2b",width:"auto",imageWidth:"100%",background:i.getAttribute("data-theme")==="dark"?"#1a1f18":"#ffffff",color:i.getAttribute("data-theme")==="dark"?"#e2ebd5":"#2b3026",backdrop:"rgba(0, 0, 0, 0.85)"})}});const e=document.createElement("style");e.textContent=".gallery-card { cursor: pointer; } .gallery-card:hover .gallery-img { transform: scale(1.1); }",document.head.appendChild(e)}function E(e){var t,a,o;try{if(e._embedded&&e._embedded["wp:featuredmedia"]&&e._embedded["wp:featuredmedia"][0]){const s=e._embedded["wp:featuredmedia"][0].source_url||((o=(a=(t=e._embedded["wp:featuredmedia"][0].media_details)==null?void 0:t.sizes)==null?void 0:a.medium)==null?void 0:o.source_url);if(s)return s}}catch{}return"./images/original/05.jpg"}function A(e){try{if(e._embedded&&e._embedded["wp:featuredmedia"]&&e._embedded["wp:featuredmedia"][0]){const t=e._embedded["wp:featuredmedia"][0].source_url;if(t)return`./images/original/${t.split("/").pop().replace(/[^a-zA-Z0-9_.-]/g,"_")}`}}catch{}return"./images/original/05.jpg"}function k(e){try{if(e._embedded&&e._embedded.author&&e._embedded.author[0])return e._embedded.author[0].name}catch{}return"admin1"}function P(e){try{if(e._embedded&&e._embedded["wp:term"]){for(let t of e._embedded["wp:term"])for(let a of t)if(a.taxonomy==="category")return a.name}}catch{}return"ประกาศ"}function $(e){try{const t=new Date(e.date),a=["มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม"],o=t.getDate(),s=a[t.getMonth()],d=t.getFullYear()+543;return`${o} ${s} ${d}`}catch{}return"8 เมษายน 2569"}window.renderAllPosts=function(e){window.wpPostsSyncInitialized=!0,console.log("Rendering posts dynamically from WordPress API...");const t=document.getElementById("slider");if(t){try{jQuery(t).hasClass("slick-initialized")&&jQuery(t).slick("unslick")}catch(r){console.log("Slick destroy ignored:",r)}t.className="slick-slider";let s="";e.slice(0,6).forEach(r=>{s+=`
                <div class="projectitem">
                    <a class="sliderlink" href="${r.link}"> </a>
                    <div class="slider-container" style="background: url(${E(r)}) 50% 50% / cover no-repeat;" data-fallback-bg="${A(r)}">
                        <div class="post-header-outer is-absolute">
                            <div class="post-header">
                                <div class="post-cat-info">
                                    <a class="cat-info-el" href="${r.link}">${P(r)}</a>
                                </div>
                                <h3 class="post-title is-size-2">
                                    <a class="post-title-link" href="${r.link}" rel="bookmark">${r.title.rendered}</a>
                                </h3>
                                <div class="post-meta-info">
                                    <div class="post-meta-info-left">
                                        <span class="meta-info-el meta-info-author">
                                            <a class="vcard author" href="${r.link}">${k(r)}</a>
                                        </span>
                                        <span class="meta-info-el meta-info-date">
                                            <time class="date update">${$(r)}</time>
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                `}),t.innerHTML=s,t.querySelectorAll(".slider-container").forEach(r=>{const M=r.style.backgroundImage.match(/url\("?([^"]*)"?\)/);if(M&&M[1]){const H=M[1],_=r.getAttribute("data-fallback-bg");if(H&&_&&!H.startsWith("data:")){const B=new Image;B.onerror=()=>{r.style.backgroundImage=`url("${_}")`},B.src=H}}});try{jQuery(t).slick({slidesToShow:1,pauseOnHover:!1,autoplaySpeed:4e3,adaptiveHeight:!1,speed:400,prevArrow:'<div class="newspaperss-slider-nav newspaperss-slider-prev"><i class="fa fa-angle-left" aria-hidden="true"></i></div>',nextArrow:'<div class="newspaperss-slider-nav newspaperss-slider-next"><i class="fa fa-angle-right" aria-hidden="true"></i></div>',responsive:[{breakpoint:1023,settings:{adaptiveHeight:!1,slidesToShow:1,slidesToScroll:1}}]})}catch(r){console.error("Failed to re-initialize slick slider:",r)}}const a=document.querySelector(".slider-right .grid-x");if(a){let s="";e.slice(0,2).forEach(r=>{s+=`
                    ...
                    <article class="post-wrap">
                        <div class="post-image-warp">
                            ...
                            <span class="thumbnail-post">
                                <a href="${r.link}">
                                    <img alt="" class="object-fit-postimg wp-post-image" height="400" loading="lazy" src="${E(r)}" width="428" onerror="this.onerror=null;this.src='${A(r)}'"/>
                                </a>
                            </span>
                        </div>
                        <div class="post-header-outer is-absolute">
                ...
                `}),a.innerHTML=s}const o=document.querySelector("#site-content .grid-x");if(o){const s=o.querySelector(".block-title");let d=s?s.outerHTML:`
            <div class="cell block-title widget-title">
                ...
                <div class="medium-6 small-12 cell large-6">
                    <div class="card layout3-post">
                        <div class="thumbnail-resize">
                            <a href="${n.link}">
                                <img alt="" class="float-center card-image wp-post-image" height="300" loading="lazy" src="${E(n)}" width="600" onerror="this.onerror=null;this.src='${A(n)}'">
                            </a>
                            <div class="post-cat-info is-absolute">
                                <a class="cat-info-el" href="${n.link}">${P(n)}</a>
                            </div>
                        </div>
                        ...
                        <div class="card-divider">
                            <span class="meta-info-el mate-info-date-icon">
                                ...
                                <a href="${n.link}" rel="bookmark">
                                    <time class="entry-date published updated">${$(n)}</time>
                                </a>
                            </span>
                            <span class="meta-info-el meta-info-author">
                ...
                `}),o.innerHTML=d}},window.renderStaticFallbacks=function(){window.wpPostsSyncInitialized=!0,console.log("Loading offline premium static data fallback from data.js...");const e=[{id:1,link:"http://www.joseph.ac.th/2026/04/08/%e0%b8%88%e0%b8%b3%e0%b8%ab%e0%b8%99%e0%b9%88%e0%b8%b2%e0%b8%a2%e0%b8%ab%e0%b8%99%e0%b8%b1%e0%b8%87%e0%b8%aa%e0%b8%b7%e0%b8%ad%e0%b9%80%e0%b8%a3%e0%b8%b5%e0%b8%a2%e0%b8%99%e0%b9%81%e0%b8%a5%e0%b8%b0-2/",title:{rendered:"จำหน่ายหนังสือเรียนและอุปกรณ์การเรียน ป.1 – ม.6 ทุกแผนก"},date:"2026-04-08T13:51:10",_embedded:{"wp:featuredmedia":[{source_url:h.images.news[0]}],author:[{name:"admin1"}],"wp:term":[[{name:"ประกาศ",taxonomy:"category"}]]}},{id:2,link:"http://www.joseph.ac.th/2026/04/08/%e0%b8%81%e0%b8%b3%e0%b8%ab%e0%b8%99%e0%b8%94%e0%b8%81%e0%b8%b2%e0%b8%a3%e0%b8%9b%e0%b8%b4%e0%b8%94%e0%b8%81%e0%b8%b4%e0%b8%88%e0%b8%81%e0%b8%a3%e0%b8%a3%e0%b8%a1%e0%b8%a0%e0%b8%b2%e0%b8%84%e0%b8%a4/",title:{rendered:"กำหนดการปิดกิจกรรมภาคฤดูร้อน 2569"},date:"2026-04-08T09:00:30",_embedded:{"wp:featuredmedia":[{source_url:h.images.news[1]}],author:[{name:"admin1"}],"wp:term":[[{name:"ประกาศ",taxonomy:"category"}]]}},{id:3,link:"http://www.joseph.ac.th/2026/04/07/%e0%b8%81%e0%b8%b4%e0%b8%88%e0%b8%81%e0%b8%a3%e0%b8%aa%e0%b8%87%e0%b8%81%e0%b8%a3%e0%b8%b2%e0%b8%99%e0%b8%95%e0%b9%8c%e0%b9%82%e0%b8%a3%e0%b8%87%e0%b9%80%e0%b8%a3%e0%b8%b5%e0%b8%a2/",title:{rendered:"กิจกรรมสงกรานต์โรงเรียนยอแซฟอุปถัมภ์"},date:"2026-04-07T09:48:42",_embedded:{"wp:featuredmedia":[{source_url:h.images.news[2]}],author:[{name:"admin1"}],"wp:term":[[{name:"กิจกรรม",taxonomy:"category"}]]}},{id:4,link:"http://www.joseph.ac.th/2026/03/13/%e0%b8%9b%e0%b8%a3%e0%b8%b0%e0%b8%89%e0%b8%b8%e0%b8%a1%e0%b8%84%e0%b8%93%e0%b8%b0%e0%b8%84%e0%b8%a3%e0%b8%b9%e0%b9%81%e0%b8%a5%e0%b8%b0%e0%b9%80%e0%b8%88%e0%b9%89%e0%b8%b2%e0%b8%ab%e0%b8%99%e0%b9%89/",title:{rendered:"ประชุมคณะครูและเจ้าหน้าที่โรงเรียนยอแซฟอุปถัมภ์ แผนกชาย"},date:"2026-03-13T15:16:34",_embedded:{"wp:featuredmedia":[{source_url:h.images.history}],author:[{name:"admin1"}],"wp:term":[[{name:"กิจกรรม",taxonomy:"category"}]]}}];window.renderAllPosts(e)};function z(){console.log("Loading posts from local cache (posts_cache.json)..."),window.wpPostsSyncInitialized=!1;const e=setTimeout(()=>{window.wpPostsSyncInitialized||(console.warn("All data sources timed out. Using static fallback."),window.renderStaticFallbacks())},5e3);fetch("./posts_cache.json?t="+Date.now()).then(t=>{if(!t.ok)throw new Error("posts_cache.json not found");return t.json()}).then(t=>{if(clearTimeout(e),Array.isArray(t)&&t.length>0)console.log("Loaded",t.length,"posts from local cache."),window.renderAllPosts(t);else throw new Error("Empty cache")}).catch(t=>{console.warn("posts_cache.json unavailable:",t.message,"— trying live WP API..."),fetch("http://www.joseph.ac.th/wp-json/wp/v2/posts?_embed&per_page=10").then(a=>{if(!a.ok)throw new Error("CORS or Network issue");return a.json()}).then(a=>{clearTimeout(e),Array.isArray(a)&&a.length>0?window.renderAllPosts(a):window.renderStaticFallbacks()}).catch(()=>{if(window.wpPostsSyncInitialized)return;const a=document.createElement("script");a.src="http://www.joseph.ac.th/wp-json/wp/v2/posts?_embed&per_page=10&_jsonp=handleWpPosts",a.onerror=()=>{clearTimeout(e),window.renderStaticFallbacks()},document.body.appendChild(a)})})}z()});window.handleWpPosts=function(i){window.wpPostsSyncInitialized||(window.wpPostsSyncInitialized=!0,console.log("JSONP fetch loaded successfully:",i),Array.isArray(i)&&i.length>0?window.renderAllPosts(i):window.renderStaticFallbacks())};
